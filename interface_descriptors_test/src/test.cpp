...
#pragma omp parallel sections
{
	#pragma omp section
			{
		receptor = new Molecule(patchRadius, minCenterDist, probeRadius, resolution,
				inname_receptor, openDX_receptor, outname_receptor, inname_radii,
				maxOrder, no_hydrogen, no_hetatm);
			}
	#pragma omp section
			{
		ligand = new Molecule(patchRadius, minCenterDist, probeRadius, resolution,
		...
		receptor->calculateDescriptors(inname_receptor, minCenterDist, patchRadius, maxOrder, complex.receptor_interface, threshold, receptor_descriptors);
		ligand->calculateDescriptors(inname_ligand, minCenterDist, patchRadius, maxOrder, complex.ligand_interface, threshold, ligand_descriptors);
