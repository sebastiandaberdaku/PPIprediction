...
public:
	static bool parseCommandLine(int const & argc, char const * const argv[],
			float & patchRadius, float & minCenterDist, float & probeRadius,
			float & resolution, string & inname1, string & inname2,
			string & outname1, string & outname2, string & inname_radii, bool & no_hydrogen,
			bool & no_hetatm, int & maxOrder, float & interface_distance,
			float & threshold, bool & help, bool & version,
