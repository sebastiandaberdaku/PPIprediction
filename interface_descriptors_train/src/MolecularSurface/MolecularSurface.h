...
public:
	...
	void extractPatchCenters(float minDistance, vector<voxel> & patchCenters);
	...
	void calculateSurfaceDescriptors(float patchRadius, int maxOrder, array3D const & interface, double threshold, vector<CompactPatchDescriptor> & descriptors);

	void calculateSurfaceDescriptors(float patchRadius, int maxOrder, vector<voxel> const & patchCenters, array3D const & interface, double threshold, vector<CompactPatchDescriptor> & descriptors);
